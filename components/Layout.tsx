    ...
    return (
        <>
            <Navbar className="sidenav" maw={300}>
                <Navbar.Section>
                    <Text color={dark ? '#339af0' : '#339af0'} fz={16}><h1 className="font1 nightflix">NIGHTFLIX</h1></Text>
                ...
                <Navbar.Section className="sideicons" grow maw={200}>
                    ...
                    <Link href="/">
                        <Box className="li" maw={98}>
                            ...
                            <Text color={dark ? '#c1c2c5' : '#495057'} fz={22}><p>Movie</p></Text>
                        </Box>
                    </Link>
                    ...
                    <Link href="/">
                        <Box className="li" maw={98}>
                            ...
                            <Text color={dark ? '#c1c2c5' : '#495057'} fz={22}><p>Trailer</p></Text>
                        </Box>
                    </Link>
